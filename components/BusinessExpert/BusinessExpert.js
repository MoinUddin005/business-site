      ...
      <div class="container">
        <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
          <div class="md:col-span-5">
            <div class="relative">
              <Image
                src="/assets/images/business/about01.jpg"
                alt="About Image"
                width={500}
                height={300}
                class="rounded-md"
              ...
              <div class="absolute bottom-24 right-0">
                <Image
                  src="/assets/images/business/about02.jpg"
                  alt="About Image 02"
                  width={500}
                  height={300}
                  class="rounded-md shadow-md w-48 h-48"
                />
          ...
          <div class="group text-center">
            ...
            <div class="mt-6">
              ...
              <p class="text-slate-400 mt-4">
                We develop digital strategies, products and services appreciated
                by clients.
              </p>
